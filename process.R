...
#processFeed <- function (feedName, day) {
  ...
  #data <- suppressWarnings(suppressMessages(read_tsv('./2017_04_03_01_0.gz', col_names = colNames, progress = F)))
  
#}

#processFeed('standard_feed', '2017_03_28')
